...
file1=open("filehandling11.txt",'r')
print(file1.read())

# Exercise 2:
# Write a Python program to copy the contents of one file to another file

with open('filehandling11.txt', 'r') as file1, open('filehandling12.txt', 'w') as file2:
    file2.write(file1.read())
file3=open("filehandling12.txt",'r')
print(file3.read())
...
try:
    new_str=int(str)
    print("The string converted to integer:",new_str)
except Exception:
